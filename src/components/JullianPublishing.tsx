...
const JullianPublishing: React.FC = () => {
  ...
  return (
    <section id="jullian-publishing" className="py-24 px-4 bg-gradient-to-br from-gray-400 via-gray-200 to-gray-300">
          ...
          <div className="space-y-8 order-1 md:order-2 text-left">
            ...
            <div ref={pointsRef} className="space-y-5 transition-all duration-700 delay-200 opacity-0 translate-y-10">
              {points.map((point, index) => (
                <div key={index} className="flex items-start gap-4 bg-blue-50/50 p-4 rounded-lg border border-blue-100">
