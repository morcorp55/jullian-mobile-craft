      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 order-1 md:order-2 text-left">
            ...
            <div 
              ref={pointsRef}
              className="space-y-5 transition-all duration-700 delay-200 opacity-0 translate-y-10"
            >
            ...
            <p 
              ref={closingRef}
              className="text-xl font-medium text-blue-600 transition-all duration-700 delay-300 opacity-0 translate-y-10 mt-6 border-l-4 border-blue-600 pl-4"
            >
